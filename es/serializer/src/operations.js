...
export var donation_create_operation_fee_parameters = new Serializer("donation_create_operation_fee_parameters", {
    fee: uint64
});
export var asset_update_issuer_operation_fee_parameters = new Serializer("asset_update_issuer_operation_fee_parameters", {
    fee: uint64
});
export var donation_create_operation = new Serializer("donation_create_operation", {
    fee: asset,
    donor_phone: string,
    donor_name: string,
    donor_id: string,
...
export var fba_distribute_operation = new Serializer("fba_distribute_operation", {
    fee: asset,
    extensions: set(future_extensions)
});
...
export var account_upgrade_merchant = new Serializer('account_upgrade_merchant', {});
export var account_upgrade_datasource = new Serializer('account_upgrade_datasource', {});
export var account_upgrade_data_transaction_member = new Serializer('account_upgrade_data_transaction_member', {});

export var stale_data_market_category_create = new Serializer('stale_data_market_category_create', {});
export var stale_data_market_category_update = new Serializer('stale_ata_market_category_update', {});

export var stale_free_data_product_create = new Serializer('stale_free_data_product_create', {});
export var stale_free_data_product_update = new Serializer('free_data_product_update', {});

export var stale_league_data_product_create = new Serializer('stale_league_data_product_create', {});
export var stale_league_data_product_update = new Serializer('stale_league_data_product_update', {});

export var stale_league_create = new Serializer('stale_league_create', {});
export var stale_league_update = new Serializer('stale_league_update', {});

export var data_market_category_create = new Serializer('data_market_category_create', {});
export var data_market_category_update = new Serializer('data_market_category_update', {});

export var free_data_product_create = new Serializer('free_data_product_create', {});
export var free_data_product_update = new Serializer('free_data_product_update', {});

export var league_data_product_create = new Serializer('league_data_product_create', {});
export var league_data_product_update = new Serializer('league_data_product_update', {});

export var league_create = new Serializer('league_create', {});
export var league_update = new Serializer('league_update', {});

export var datasource_copyright_clear = new Serializer('datasource_copyright_clear', {});
export var data_transaction_complain = new Serializer('data_transaction_complain', {});

export var balance_lock = new Serializer('balance_lock', {
    fee: asset,
    account: protocol_id_type("account"),
    create_date_time: time_point_sec,
    program_id: string,
...
export var balance_unlock = new Serializer('balance_unlock', {
    fee: asset,
    account: protocol_id_type("account"),
...
export var data_transaction_create = new Serializer("data_transaction_create", {
    request_id: string,
...
export var data_transaction_update = new Serializer("data_transaction_update", {
    request_id: string,
    new_status: uint8,
    fee: asset,
...
export var data_transaction_pay = new Serializer("data_transaction_pay", {
    fee: asset,
    from: protocol_id_type('account'),
    to: protocol_id_type('account'),
    amount: asset,
...
export var data_transaction_datasource_upload = new Serializer("data_transaction_datasource_upload", {
    request_id: string,
    requester: protocol_id_type('account'),
...
export var data_transaction_datasource_validate_error = new Serializer("data_transaction_datasource_validate_error", {
    request_id: string,
    datasource: protocol_id_type('account'),
    fee: asset,
    extensions: set(future_extensions)
...
export var proxy_transfer_params = new Serializer("proxy_transfer_params", {
...
export var signed_proxy_transfer_params = new Serializer("signed_proxy_transfer_params", {
    from: protocol_id_type('account'), // 从该帐户转帐，转帐数量为amount
    to: protocol_id_type('account'), // 转帐至该帐户
    proxy_account: protocol_id_type('account'), // 代理记帐方
    amount: asset,
...
export var proxy_transfer = new Serializer("proxy_transfer", {
    proxy_memo: string,
    fee: asset,
