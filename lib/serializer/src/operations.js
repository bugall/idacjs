...
export const donation_create_operation_fee_parameters = new Serializer("donation_create_operation_fee_parameters", {
    fee: uint64
});
export const asset_update_issuer_operation_fee_parameters = new Serializer("asset_update_issuer_operation_fee_parameters", {
    fee: uint64
});
export const donation_create_operation = new Serializer("donation_create_operation", {
    fee: asset,
    donor_phone: string,
    donor_name: string,
    donor_id: string,
...
var fee_parameters = static_variant([
    ...
    asset_settle_cancel_operation_fee_parameters,
    asset_claim_fees_operation_fee_parameters,
    donation_create_operation_fee_parameters,
